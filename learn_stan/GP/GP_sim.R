#from https://github.com/stan-dev/example-models/blob/master/misc/gaussian-process/gp-sim.R
...
fit_sim <- stan(file="GP_sim.stan", data=list(x=x,N=N), iter=200, chains=1);
