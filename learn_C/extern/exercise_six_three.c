/* copied from http://clc-wiki.net/wiki/K%26R2_solutions:Chapter_6:Exercise_3
want to see if it works with my compiler */
/* which yes, it does; click ctrl-d in unix to stop it */ 
