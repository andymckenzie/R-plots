#modified script from Mark Patterson, basically just messing around with their parameters
...
im.func.1 = function(image, k.cols = 25, samp.val = 3000){
...
temp = im.func.1(img.2, samp.val = 25000, k = 15)
